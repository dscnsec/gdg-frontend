  ...
  return (
    <section className="p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
        ...
        {/* Web */}
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-yellow-400 rounded-lg text-center">
          <Image src={web} alt="Web" width={120} height={120} className="mb-4" />
          <p className="font-bold text-2xl text-yellow-400 mt-2">Web</p>
        </div>

        {/* Web3 */}
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-green-500 rounded-lg text-center sm:col-span-2">
        ...
        {/* App */}
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-blue-400 rounded-lg text-center">
        ...
        {/* OpenSource */}
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-red-400 rounded-lg text-center">
        ...
        {/* AI/ML */}
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-blue-500 rounded-lg text-center lg:col-span-3">
        ...
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-yellow-400 rounded-lg text-center sm:col-span-2">
        ...
        {/* Public Relations */}
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-blue-500 rounded-lg text-center">
        ...
        {/* Cloud */}
        <div className="flex flex-col items-center justify-center w-full h-60 p-4 border-4 border-b-8 border-green-500 rounded-lg text-center">
