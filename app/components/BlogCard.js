const BlogCard = () => {
  return (
    <div className="flex cursor-pointer flex-col gap-4 border-2 border-black rounded-lg rounded-t-3xl shadow-lg w-full max-w-[390px] min-h-[400px]">
      {/* img */}
      <img 
    ...
    {/* Text In between */}
      ...
      {/* Tags */}
      <div className="flex flex-wrap items-center justify-between bg-white p-4 rounded-lg shadow-md">
